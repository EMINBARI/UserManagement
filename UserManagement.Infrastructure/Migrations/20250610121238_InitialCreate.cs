    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Some Read description", true, "Read" },
                    { 2, "Some Write description", true, "Write" },
                    { 3, "Some Update description", true, "Update" },
                    { 4, "Some Delete description", true, "Delete" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Some Admin description", "Admin" },
                    { 2, "Some User description", "User" }
                });
